            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="#"><i class="fa fa-user"></i><?php echo isset($_SESSION['email']) ? $_SESSION['email'] : 'Account' ;?></a></li>
                            <li><a href="#"><i class="fa fa-star"></i> Wishlist</a></li>
                            <li><a href="<?php echo $this->url('pages','panier');?>"><i class="fa fa-shopping-cart"></i> Panier</a></li>
                            <li><a href="<?php echo $this->url('pages','login');?>"><i class="fa fa-lock"></i> Login</a></li>
                        </ul>
                    </div>
                </div>
            </div>
