                ...
                <div class="col-sm-6 clearfix">
                    <div class="bill-to">
                        ...
                        <div class="form-one">
                            ...
                            <?php foreach($viewOrder as $order)  { ;?>
                                <li><a href="<?php echo $this->url('pages','commande',$order->getId()) ?>"> Commande n°<?php echo isset($order) ? $order->getId() : ''; ?> effectuée le <?php echo isset($order) ? $order->getDateCommande() : ''; ?> (<?php echo isset($order) ? $order->getStatut() : ''; ?>) </a></h4></li>
                            <?php } ?>
                                </ul>
                        </div>
                    </div>
